...
<html>
  ...
  <body>
    <svg
      ...
      viewBox="0 0 561.64 310"
    >
      <defs>
        <!-- mask에는 실제 폰트영역 부분만 붙여넣어준 뒤, id(logo-mask) 값을 부여해준다. -->
        <mask id="logo-mask">
          <g>
            <path
              class="cls-1"
        ...
        <style>
          ...
          @keyframes dash-ani {
            from {
              stroke-dashoffset: 5171; /* getTotalLength 메서드로 구해온 값 */
            }
            to {
              stroke-dashoffset: 0;
            }
          ...
          .cls-2 {
            ...
            stroke-linejoin: round;
            stroke-width: 25px;
            stroke-dasharray: 5171; /* getTotalLength 메서드로 구해온 값 */
            stroke-dashoffset: 0;
            fill: transparent;
            animation: dash-ani 8s linear; /* linear 값을 주면 일정한 속도로 움직인다. */
          }
        </style>
      </defs>

      <!-- 마스크 효과는 g 태그로 감싼 뒤 mask 프로퍼티에 url(#logo-mask)로 부여한다. -->
      <g mask="url(#logo-mask)">
        <!-- 아래 태그가 실제 펜툴로 폰트를 덮도록 그린 path 영역임 -->
        <path
          class="cls-2"
          d="M200.5,296.5s-6-20-34-21c0,0-27-1-30,21,0,0-6,23,32,24,0,0,31,1,27,26,0,0,1,24-29,24,0,0-26,3-34-27l82-65,87-3-44-27v131l48-131,21,20v69s5,31,31,31c0,0,24-1,29-30,0,0,6-66,0-80l48-18,7,21-22,100s59,25,69-38c0,0,3-28-15-39l-43-17,97-15v140l20-124,27-28-1,48s-27,41,13,74c0,0,25,16,44-13,0,0,11-47-24-68h-48l-463,92,4,138,35,14,3-124,36,51,37-53v114l13-137,20,24v93l-3-122,74,11,5,19h-68l-1,44h64l-87,30v19h69l17,26,49-118,45,111-96-23,3-18,86-1v-88l35-5-5,21s-10,51,6,76c0,0,26,26,95,22,0,0,79-2,90-37l-17-4s8-45-45-21l-22,71,23,8s24-98,40-111"
          transform="translate(-83 -228)"
    ...
    <script>
      console.log(document.querySelector(".cls-2").getTotalLength());
    </script>
  </body>
</html>
```

위 주석을 하나씩 보며 이해하자 : ) 위 코드로 구현된 결과물은 아래와 같다.
